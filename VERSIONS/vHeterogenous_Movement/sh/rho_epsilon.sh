...
do
    ...
    do
        ...
        python3 ~/research/AutomatAnts/code/Heterogeneity/run_cluster.py --directory ~/research/AutomatAnts/results/2025/rho_epsilon_with_tags/ --filename rho_${rho/,/.}_epsilon_${epsilon/,/.} --social_feedbacks both -n 100 -p "rho=${rho/,/.};epsilon=${epsilon/,/.}"
